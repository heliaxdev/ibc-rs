...
def passive_packets(
    ...
    # hermes tx raw ft-transfer ibc-1 ibc-0 transfer channel-0 100 -o 1000 -n 2
    ...
    # hermes tx raw ft-transfer ibc-0 ibc-1 transfer channel-1 100 -o 1000 -n 2
    ...
    # hermes tx raw ft-transfer ibc-0 ibc-1 transfer channel-1 100 -o 1000 -n 3
    packet.packet_send(c, src=ibc1, dst=ibc0, src_port=port_id,
                       src_channel=ibc1_channel_id, amount=100, height_offset=1000, number_msgs=3)

    # hermes tx raw ft-transfer ibc-1 ibc-0 transfer channel-0 100 -o 1000 -n 4
    packet.packet_send(c, src=ibc0, dst=ibc1, src_port=port_id,
    ...
    # 7. send some packets
    # hermes tx raw ft-transfer ibc-0 ibc-1 transfer channel-1 100 1000 -n 3
    packet.packet_send(c, src=ibc1, dst=ibc0, src_port=port_id,
                       src_channel=ibc1_channel_id, amount=100, height_offset=1000, number_msgs=3)

    # hermes tx raw ft-transfer ibc-1 ibc-0 transfer channel-0 100 1000 -n 4
    packet.packet_send(c, src=ibc0, dst=ibc1, src_port=port_id,
                       src_channel=ibc0_channel_id, amount=100, height_offset=1000, number_msgs=4)
